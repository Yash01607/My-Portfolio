...
export const Experience = [
  {
    ...
    image: beehyvImage,
    desc: [
      "Co-developing a GEN-AI soltion to generate documents vector embeddings for enhanced query responses, using the RAG Framework(Retrieval-Augmented Generation).",
      "Implemented various document Vector-Embeddings Techniques as Independent Microservices.",
      "Co-created a search tool that scrapes websites to offer real-time information for user queries.",
      "Reduced the Search service response time by 80% by implementing MultiThreading and Caching.",
      ...
      "Frequently carried out POCs to drive better project development",
      "Integrated GIDR with over 15 Models like OpenAI, Claude, Gemini, Groq and LLaMA.",
      "Built SQL and Database Mmigration scripts, while also developing scripts for Vector Databases and Similarity Search Functions.",
    ],
    techStack: [
      "Python",
      "FastAPI",
