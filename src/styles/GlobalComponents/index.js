...
export const ButtonBack = styled.div`
  ...
  height: ${({ alt, certificate }) =>
    alt ? "52px" : certificate ? "40px" : "64px"};
  border-radius: ${({ certificate }) => (certificate ? "5px" : "50px")};
  font-size: ${({ alt }) => (alt ? "20px" : "24px")};
  font-weight: 600;
  display: flex;
  align-items: center;
  justify-content: center;
  margin: ${({ alt, form, certificate }) =>
    alt || form ? "0" : certificate ? "20px 0 20px auto" : "0 0 80px"};
  color: #fff;
  background: ${({ alt }) =>
    alt
